...
// Configuration
const CLIENT_ID = "903516254980-r45tb1cpu9ln9n8jhfhdl71nf4h0s51t.apps.googleusercontent.com";
const CLIENT_SECRET = "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";
const REDIRECT_URI = process.env.GOOGLE_REDIRECT_URI || 'http://localhost:3000/oauth2callback';
const REFRESH_TOKEN = process.env.GOOGLE_REFRESH_TOKEN;
const TOPIC_NAME = process.env.GOOGLE_PUBSUB_TOPIC || "projects/emails-478608/topics/readEmail";
